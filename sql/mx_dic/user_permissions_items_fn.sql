-- =====================================================================
-- ФУНКЦІЇ ТА ТРИГЕРИ ДЛЯ УПРАВЛІННЯ sort_order У ПУНКТАХ ПОВНОВАЖЕНЬ
-- Таблиця: mx_dic.user_permissions_items
-- Логіка:
...
-- -------------------------------------------------
DROP TRIGGER IF EXISTS trg_user_permissions_items_bi_sort_order
  ON mx_dic.user_permissions_items;

DROP TRIGGER IF EXISTS trg_user_permissions_items_bu_sort_order_reorder
  ON mx_dic.user_permissions_items;

DROP TRIGGER IF EXISTS trg_user_permissions_items_ad_sort_order_reorder
  ON mx_dic.user_permissions_items;
