-- =====================================================================
-- ФУНКЦІЇ ТА ТРИГЕРИ ДЛЯ УПРАВЛІННЯ sort_order У МЕНЮ ПРИЛОЖЕННЯ
-- Таблиця: mx_dic.menus
-- Логіка:
--   - автоприсвоєння sort_order при INSERT
--   - перерозподіл sort_order при UPDATE (drag&drop для ранжування меню)
...
-- -------------------------------------------------
DROP TRIGGER IF EXISTS trg_menus_bi_sort_order
  ON mx_dic.menus;

DROP TRIGGER IF EXISTS trg_menus_bu_sort_order_reorder
  ON mx_dic.menus;

DROP TRIGGER IF EXISTS trg_menus_ad_sort_order_reorder
  ON mx_dic.menus;
...
BEGIN
    ...
    -- номер в глобальному списку меню.
...
--    (drag&drop для ранжування меню між собою)
-- =====================================================================
...
BEGIN
    ...
    -- Ущільнюємо порядок:
    -- всі меню з більшим sort_order зсуваємо на 100 вгору.
    UPDATE mx_dic.menus
    SET sort_order = sort_order - 100
