 ...
 */
const fuzzyFilter: FilterFn<SessionView> = (row, columnId, value, addMeta) => {
...
/**
 * Таблиця сесій з глобальним пошуком та пагінацією
 *
  ...
  return (
    <div className="w-full space-y-4">
      <div className="flex items-center justify-between">
        <Input
          placeholder="Пошук по користувачу, IP-адресі або пристрою..."
          value={globalFilter ?? ''}
