...
import { createMenuGeneralItem } from '@/data/mx-dic/menu-general';
import {
...
/**
 * Server Action для створення нового пункту загального меню (без прив'язки до офісу)
 */
export async function createMenuGeneralItemAction(
  menuId: number,
  title: string,
  url: string,
  icon: string
  ...
  try {
    ...
    console.log('[createMenuGeneralItemAction] Пункт загального меню створено');
    ...
    console.error('[createMenuGeneralItemAction] Помилка створення пункту загального меню:', error);
